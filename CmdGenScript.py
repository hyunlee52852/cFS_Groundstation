...
CSP_Client = ctypes.CDLL("./CSP_Client.so")
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, *args, obj=None, **kwargs):
        ...
        # Connect the button to send CSP Commnad
        self.pushButton_SendCSP.clicked.connect(self.send_csp)
        # Refresh Ports
        self.refresh_ports()
    ...
    def send_csp(self):
        ...
        status = CSP_Client.SendCmd(bytes_to_send, len(bytes_to_send))
        print(status)
